...
function twentyseventeen_widgets_init() {
	register_sidebar(
		array(
			...
			'before_title'  => '<h2 class="widget-title" style="color: #bf8a2e;">',
			'after_title'   => '</h2>',
		)
	);
	...
	register_sidebar(
		array(
			'name'          => __( 'Shop Bar', 'twentyseventeen' ),
			'id'            => 'shop-searcher',
			'description'   => __( 'Add widgets here to appear in your sidebar on blog posts and archive pages.', 'twentyseventeen' ),
			'before_widget' => '<div class="d-block d-md-inline-block w-100 w-md-auto mb-2 mb-md-0">',
			'after_widget'  => '</div>',
...
function twentyseventeen_scripts() {
	...
	wp_enqueue_script( 'jquery-scrollto', get_theme_file_uri( '/assets/js/lazy.js' ), array( 'jquery' ), '2.1.2', true );
