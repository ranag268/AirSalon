	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-12 col-md-4 text-center">
				<div class="" style="height: 400px; width: 94%; margin: 0 3%; background-image: url(<?php echo includes_url('images/img1.png'); ?>); background-repeat: no-repeat; background-size: cover; background-position: center center;">
				</div>
					<a href="shop" class="btn btn-custom mt-2">
						Take me there
					</a>
			</div>
			<div class="col-12 col-md-4 md-hidden text-center">
				<div class="" style="height: 400px; width: 94%; margin: 0 3%; background-image: url(<?php echo includes_url('images/img2.png'); ?>); background-repeat: no-repeat; background-size: cover; background-position: center center;">
				</div>
					<a href="shop" class="btn btn-custom mt-2">
						Take me there
					</a>
			...
			<div class="col-12 col-md-4 md-hidden text-center">
				<div class="" style="height: 400px; width: 94%; margin: 0 3%; background-image: url(<?php echo includes_url('images/img3.png'); ?>); background-repeat: no-repeat; background-size: cover; background-position: center center;">
				</div>
				<a href="shop" class="btn btn-custom mt-2">
					Take me there
				</a>
